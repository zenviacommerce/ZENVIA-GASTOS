...
function InvoiceDetail({invoice,settings,allowEditIssuedInvoices,onClose,onPdf,onPrint,onPayment,onSend,onRectify,onEdit,onReopen,onDelete,onIssue}:{invoice:SalesInvoice|null;settings:BusinessSettings;allowEditIssuedInvoices:boolean;onClose:()=>void;onPdf:(invoice:SalesInvoice)=>void;onPrint:(invoice:SalesInvoice)=>void;onPayment:(invoice:SalesInvoice)=>void;onSend:(invoice:SalesInvoice)=>void;onRectify:(invoice:SalesInvoice)=>void;onEdit:(invoice:SalesInvoice)=>void;onReopen:(invoice:SalesInvoice)=>void;onDelete:(invoice:SalesInvoice)=>void;onIssue:(invoice:SalesInvoice)=>void}){
