...
export function Invoices({invoices,suppliers,onUpload,onStatusChange,onOpenFile,onDelete}:{invoices:Invoice[];suppliers:Supplier[];onUpload:()=>void;onStatusChange:(id:string,status:'pending'|'reviewed'|'accounted')=>Promise<void>;onOpenFile:(invoice:Invoice)=>Promise<void>;onDelete:(invoice:Invoice)=>Promise<void>}){
