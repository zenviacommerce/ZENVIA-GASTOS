...
export function Dashboard({invoices,products,suppliers,onUpload,onProducts}:{invoices:Invoice[];products:Product[];suppliers:Supplier[];onUpload?:()=>void;onProducts?:()=>void}){
  ...
  return <div className="page">
    <div className="pageHead"><div><div className="eyebrow">{selectedPeriod}</div><h1>Resumen de gastos</h1><p>Control fiscal y costes de ZENVIA COMMERCE en un solo sitio.</p></div>{onUpload&&<button className="primary" onClick={onUpload}>+ Nueva factura</button>}</div>
