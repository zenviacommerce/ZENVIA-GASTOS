...
import { SalesInvoiceNumberEditor } from './components/SalesInvoiceNumberEditor';
...
ReactDOM.createRoot(document.getElementById('root')!).render(<React.StrictMode><App/><AutoPagination/><OrderLabelDefaults/><PendingOrdersKpiHighlight/><SalesInvoiceNumberEditor/><UnifiedListExperience/></React.StrictMode>);
