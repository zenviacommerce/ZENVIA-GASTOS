...
ReactDOM.createRoot(document.getElementById('root')!).render(<React.StrictMode><App/><AutoPagination/><OrderLabelDefaults/><PendingOrdersKpiHighlight/><UnifiedListExperience/></React.StrictMode>);
