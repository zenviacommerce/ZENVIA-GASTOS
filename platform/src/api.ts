...
export const platformApi={
  ...
  listUsers:()=>invoke<{users:PlatformUser[];roles:PlatformRoleDefinition[];permissions:PlatformPermission[];rolePermissions:Array<{role_key:PlatformRole;permission_key:string}>}>('list_users'),
