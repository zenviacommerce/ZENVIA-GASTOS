-- Within the newest current sync batch, refresh orders before finances and inventory.
-- This keeps the dashboard's headline sales/order metrics fresh first while historical backfill continues.
